namespace cuadernito.MicroServices.Conversations.Commands
{
    ...
    /// <summary>
    /// A <see cref="ICommand{TAuthenticationToken}"/> that instructs the <see cref="Conversation"/> to delete itself.
    /// </summary>
    [Serializable]
    [DataContract]
    public class DeleteConversation : ICommand<Guid>
    {
        ...
        /// <summary>
        /// The conversation that is to be deleted.
        /// </summary>
        [DataMember]
