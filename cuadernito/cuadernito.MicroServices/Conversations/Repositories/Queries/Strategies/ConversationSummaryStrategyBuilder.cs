namespace cuadernito.MicroServices.Conversations.Repositories.Queries.Strategies
{
    using System;
    ...
    public class ConversationSummaryQueryStrategyBuilder : QueryBuilder<ConversationSummaryQueryStrategy, ConversationSummaryEntity>
    {
        ...
        {
            return DependencyResolver.Resolve<IDomainDataStoreFactory>().GetConversationSummaryDataStore();
        }
    }
}