namespace cuadernito.MicroServices.Conversations.Services.WcfResolvers
{
    ...
    /// <summary>
    /// A <see cref="DataContractResolver"/> for using <see cref="IConversationService.PostComment"/> via WCF
    /// </summary>
    public class ConversationServicePostCommentParametersResolver : BasicServiceParameterResolver<IConversationService, Guid>
    {
        public ConversationServicePostCommentParametersResolver()
        ...
        {
            if (dataContractType == typeof(ServiceRequestWithData<Guid, ConversationService.PostCommentParameters>))
            {
                XmlDictionary dictionary = new XmlDictionary();
                typeName = dictionary.Add("ConversationServicePostCommentParameters");
        ...
        public override Type ResolveName(string typeName, string typeNamespace, Type declaredType, DataContractResolver knownTypeResolver)
        {
            ...
            {
                if (typeName == "ConversationServicePostCommentParameters")
                    return typeof(ServiceRequestWithData<Guid, ConversationService.PostCommentParameters>);
            }
        ...
        {
            WcfDataContractResolverConfiguration.Current.RegisterDataContract<IConversationService, ConversationServicePostCommentParametersResolver>("PostComment");
        }
    }
}