namespace cuadernito.MicroServices.Conversations.Services.WcfResolvers
{
    ...
    /// <summary>
    /// A <see cref="DataContractResolver"/> for using <see cref="IConversationService.StartConversation"/> via WCF
    /// </summary>
    public class ConversationServiceStartConversationParametersResolver : BasicServiceParameterResolver<IConversationService, Guid>
    {
        public ConversationServiceStartConversationParametersResolver()
        ...
        {
            if (dataContractType == typeof(ServiceRequestWithData<Guid, ConversationService.StartConversationParameters>))
            {
                XmlDictionary dictionary = new XmlDictionary();
                typeName = dictionary.Add("ConversationServiceStartConversationParameters");
        ...
        public override Type ResolveName(string typeName, string typeNamespace, Type declaredType, DataContractResolver knownTypeResolver)
        {
            ...
            {
                if (typeName == "ConversationServiceStartConversationParameters")
                    return typeof(ServiceRequestWithData<Guid, ConversationService.StartConversationParameters>);
            }
        ...
        {
            WcfDataContractResolverConfiguration.Current.RegisterDataContract<IConversationService, ConversationServiceStartConversationParametersResolver>("StartConversation");
        }
    }
}