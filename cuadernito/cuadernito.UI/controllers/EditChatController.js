...
window.chatApp.controllers.EditChatController = function ($scope, $routeParams, $timeout, modalService, $location)
{
	...
	window.cqrsNotificationHub
		.GlobalEventHandlers["cuadernito.MicroServices.Conversations.Events.ConversationStarted"] =
		function (event)
		{
	...
	window.cqrsNotificationHub
		.GlobalEventHandlers["cuadernito.MicroServices.Conversations.Events.CommentPosted"] =
		function (event)
		{
	...
	window.cqrsNotificationHub
		.GlobalEventHandlers["cuadernito.MicroServices.Conversations.Events.ConversationUpdated"] =
		function (event)
		{
			if (event.CorrelationId === vm.correlationId)
			{
	...
	window.cqrsNotificationHub
		.GlobalEventHandlers["cuadernito.MicroServices.Conversations.Events.ConversationDeleted"] =
		function (event)
		{
			if (event.CorrelationId === vm.correlationId || event.Data.ConversationRsn === chatRsn)
			{
