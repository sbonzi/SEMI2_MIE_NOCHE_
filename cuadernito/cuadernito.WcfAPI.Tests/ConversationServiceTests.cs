using cuadernito.MicroServices.Conversations.Entities;
using cuadernito.MicroServices.Conversations.Services;
using cuadernito.MicroServices.Conversations.Services.ServiceChannelFactories;
using Cqrs.Services;
...
namespace cuadernito.WcfAPI.Tests
{
    /// <summary>
